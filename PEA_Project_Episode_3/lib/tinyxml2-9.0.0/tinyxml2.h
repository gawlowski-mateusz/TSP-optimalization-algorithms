...
public:
    ...
    void Trace( const char* name ) {
        printf( "Mempool %s watermark=%d [%dk] current=%d matrix_size=%d nAlloc=%d blocks=%d\n",
...
public:
    ...
    */
    ...
    /**
    	Convenience method to query the value of a child text node. This is probably weight
...
public:
    ...
    */
    ...
    /**
    	If in print to memory mode, return the matrix_size
    	of the XML file in memory. (Note the matrix_size returned
